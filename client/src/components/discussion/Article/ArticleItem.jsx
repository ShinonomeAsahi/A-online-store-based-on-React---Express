  ...
  return (
    <div className="bg-white shadow-md rounded-lg p-6 mb-4">
      <div className="flex items-center mb-4">
        <img src={`https://picsum.photos/200`} alt={article.author} className="w-10 h-10 rounded-full mr-3" />
        <div>
      ...
      <div className="flex justify-between text-gray-600">
        ...
        <>
          <img src="https://picsum.photos/200" alt="User 1" className="w-8 h-8 rounded-full" />
          <img src="https://picsum.photos/200" alt="User 2" className="w-8 h-8 rounded-full" />
          <img src="https://picsum.photos/200" alt="User 3" className="w-8 h-8 rounded-full" />
        </>
        </div>
      </div>
    </div>
